...
const handleClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
  ...
  Swal.fire({
    ...
    text: 'We\'re gonna need a bigger boat. Please copy this email address: LmntryLmnt@gmail.com',
      ...
      <div className="contact-info d-flex mt-4 justify-content-center">
        <ul className="list-unstyled">
          ...
          <li>
            ...
            <a href="mailto:LmntryLmnt@gmail.com?subject=Subject%20Here&body=Your%20message%20goes%20here" onClick={handleClick} style={{ color: 'rgb(208, 210, 224)', textDecoration: 'none' }}>
