      ...
      >
        ...
        <div className="col-12 col-md-6 col-lg-4 mb-4 mt-4 d-flex flex-column align-items-center">
          ...
          <p className="text-center desc">
            Here are some of the projects I have worked on. Click on the title to view the GitHub repo.
          </p>
        </div>
        <div className="imgbox">
          <div className="imgboxitem col-12 col-md-6 col-lg-4 mb-2">
            <img src={tspPic} className="img img-fluid" alt="Project 1" />
                <div className='d-flex align-items-baseline'>
                  ...
                  <a className="projLink" href="https://github.com/Vtencouchclimbr/Tech-Shopper-Pro" target="_blank" rel="noopener noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>Tech Shopper Pro<svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
                  </a>
                  <h3 className="click">Click Here!</h3>
                </div>
          ...
          <div className="imgboxitem col-12 col-md-6 col-lg-4 mb-2">
            <img src={socialNetwork} className="img img-fluid" alt="Project 2" />
              <div className='d-flex align-items-baseline'>
                <h3 className="click">Click Here!</h3>
                <a className="projLink" href="https://github.com/Vtencouchclimbr/Social-Network-API" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>Social Network App<svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
                </a>
                <h3 className="click">Click Here!</h3>
              </div>
          ...
          <div className="imgboxitem col-12 col-md-6 col-lg-4 mb-2">
            <img src={kanBan} className="img img-fluid" alt="Project 3" />
              <div className='d-flex align-items-baseline'>
                <h3 className="click">Click Here!</h3>
                <a className="projLink" href="https://github.com/Vtencouchclimbr/Module-14-Challenge_Kanban-Board" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>Kanban Board<svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
                </a>
                <h3 className="click">Click Here!</h3>
              </div>
          ...
          <div className="imgboxitem col-12 col-md-6 col-lg-4 mb-2">
            <img src={bookSearch} className="img img-fluid" alt="Project 4" />
              <div className='d-flex align-items-baseline'>
                <h3 className="click">Click Here!</h3>
                <a className="projLink" href="https://github.com/Vtencouchclimbr/Book-Search-Engine" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>Book Search Engine<svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
                </a>
                <h3 className="click">Click Here!</h3>
              </div>
          ...
          <div className="imgboxitem col-12 col-md-6 col-lg-4 mb-2">
            ...
            <div className='d-flex align-items-baseline'>
                <h3 className="click">Click Here!</h3>
                <a className="projLink" href="https://github.com/Vtencouchclimbr/Test-Suite" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"/></svg>Testing Suite<svg xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="12px" fill="#e8eaed"><path d="m313-440 224 224-57 56-320-320 320-320 57 56-224 224h487v80H313Z"/></svg>
                </a>
                <h3 className="click">Click Here!</h3>
              </div>
